  ...
  class NodeAttributes
    ...
    def _deserialize(type, value)
      ...
      when /\AHash<(?<k_type>.+), (?<v_type>.+)>\z/
        ...
        _model = BlueprintClient.const_get(type).new
